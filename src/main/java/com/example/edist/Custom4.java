...
public class Custom4 extends BaseAdapter {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        TextView tv1=(TextView)gridView.findViewById(R.id.c4t1);
        TextView tv2=(TextView)gridView.findViewById(R.id.c4t2);
        TextView tv3=(TextView)gridView.findViewById(R.id.c4t3);
        TextView tv4=(TextView)gridView.findViewById(R.id.c4t4);
